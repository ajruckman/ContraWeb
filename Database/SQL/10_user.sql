DROP TABLE IF EXISTS contraweb.user_session CASCADE;
DROP TABLE IF EXISTS contraweb.user CASCADE;

CREATE TABLE contraweb.user
(
...
CREATE TABLE contraweb.user_session
(
    username     VARCHAR(16) NOT NULL,
